...
module "bedrock_kb" {
  ...
  aurora_arn        = "arn:aws:rds:us-west-2:929355795332:cluster:my-aurora-serverless"
  aurora_db_name    = "myapp"
  aurora_endpoint   = "my-aurora-serverless.cluster-cgkbr2sqqfef.us-west-2.rds.amazonaws.com"
  ...
  aurora_secret_arn = "arn:aws:secretsmanager:us-west-2:929355795332:secret:my-aurora-serverless-WSlzvD"
  s3_bucket_arn = "arn:aws:s3:::bedrock-kb-929355795332"
}